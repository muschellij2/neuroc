...
```{r plot_eve_labs_color_spect_random}
set.seed(20161008)
...
Here we will use the N4 corrected, processed images from [Processing Within-Visit MRI](../preprocess_mri_within/index_notoc.html) and register the Eve T1 brain to the processed T1 image.  Let us get the filenames that we want:

```{r eve_to_t1_files, cache = TRUE}
...
```{r native_long_join, cache=FALSE}
